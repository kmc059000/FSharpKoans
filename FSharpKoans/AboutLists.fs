...
module ``about lists`` =
    ...
    let FilteringListsWithFilter() =
        ...
        let oddResult = List.filter isOdd original
        AssertEquality oddResult [1;3;5]
    ...
    let DividingListsWithPartition() =
        ...
        let result3, result4 = List.partition isEven original
        AssertEquality result3 [0;2;4]
        AssertEquality result4 [1;3;5]
