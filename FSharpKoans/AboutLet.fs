...
module ``about let`` =
    ...
    let LetInfersTheTypesOfValuesWherePossible() =
        ...
        let z = 0.005m
        let expectedTypeZ = z.GetType()
        AssertEquality expectedTypeZ typeof<decimal>
    ...
    let ModifyingTheValueOfVariables() =
        ...
        let mutable y = "kenneth"
        y <- "crawford"

        AssertEquality y "crawford"

        y <- "kenneth " + y
        AssertEquality y "kenneth crawford"
